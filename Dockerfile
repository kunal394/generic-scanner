...
ENV TERM linux
LABEL version="1.0" description="Docker build file providing a generic scanner docker image exposing different web app scanners in order to use the image as a command line tool"
